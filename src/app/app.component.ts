...
export class AppComponent implements OnInit{
  ...
  loadMobile()
  {
    ...
    this.http.get<any[]>(`http://localhost:8081/mobile/getallmobile`).subscribe({
      next:data=>
      {
        this.mobiles=data;
      },
  ...
  deleteMobile(id:any)
  {
    ...
    this.http.delete(`http://localhost:8081/mobile/deletemobile/${id}`).subscribe({
      next:data=>{
        this.loadMobile();
      },
      error:err=>console.log(err)
...
this.http.put(`http://localhost:8081/mobile/updatemobile/${this.mobile.id}`,this.mobile).subscribe({
    ...
    this.http.post(`http://localhost:8081/mobile/addmobile`,this.mobile).subscribe({
      next:data=>{
